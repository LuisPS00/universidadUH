...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:GridView ID="GridView1" runat="server" Height="146px" Width="239px" AutoGenerateColumns="False" CellPadding="4" DataSourceID="UserSqlserver" ForeColor="#333333" GridLines="None">
            ...
            <asp:SqlDataSource ID="UserSqlserver" runat="server" ConnectionString="<%$ ConnectionStrings:UHUNIVERSIDADConnectionString3 %>" DeleteCommand="delete usuario where codigo = @codigo" InsertCommand="insert into usuario (Nombre, clave, edad) values(@nombre,@clave,@edad)" OnSelecting="UserSqlserver_Selecting" SelectCommand="SELECT * FROM [Usuario]where codigo =@codigo" UpdateCommand="update usuario set nombre = @nombre, clave=@clave where codigo=@codigo">
                <DeleteParameters>
            ...
            <br />
            Filtro&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDatanom" DataTextField="Nombre" DataValueField="Codigo" Height="24px" Width="140px">
            </asp:DropDownList>
            <asp:SqlDataSource ID="SqlDatanom" runat="server" ConnectionString="<%$ ConnectionStrings:UHUNIVERSIDADConnectionString3 %>" SelectCommand="SELECT [Codigo], [Nombre] FROM [Usuario]"></asp:SqlDataSource>
            <br />
            <br />
            <br />
